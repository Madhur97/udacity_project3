...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
        ...
        // I have commented/removed the below code (for checking events) in all the tests 
        // because I have used truffleAssert. Test was failing with the below commented code.
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        var event = await supplyChain.buyItem(upc, {from: distributorID, value: web3.toWei("0.01", "ether")});
